...
:class:`integrative_transcriptomics_viewer.genomesource.FastaGenomeSource`) or in memory 
(:class:`integrative_transcriptomics_viewer.genomesource.GenomeSource`).
"""
