...
# Read the project version without importing heavy runtime dependencies.
from pathlib import Path
import re

root_dir = Path(__file__).resolve().parents[1]
init_path = root_dir / "src" / "integrative_transcriptomics_viewer" / "__init__.py"
init_content = init_path.read_text(encoding="utf-8")
version_match = re.search(r'^__version__ = ["\']([^"\']+)["\']', init_content, re.MULTILINE)
...
html_title = "ITV Documentation"
html_short_title = "ITV Docs"
html_theme_options = {
    "logo": {
        "text": "ITV Documentation",
    },
}
